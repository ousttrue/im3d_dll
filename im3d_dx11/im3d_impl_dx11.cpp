...
public:
    void Draw(ID3D11DeviceContext *ctx, const float *viewProjection, int w, int h, const Im3d::DrawList *drawList, int count)
    {
...
Im3dImplDx11Impl *g_impl = nullptr;
...
{
    g_impl->Draw((ID3D11DeviceContext*)deviceContext, viewProjection, w, h, drawList, count);
}

DX11_EXPORT bool Im3d_DX11_Initialize()
{
    g_impl = new Im3dImplDx11Impl();
    return true;
}
